...
Layer<Dtype>* GetLayer(const LayerParameter& param) {
  ...
  case LayerParameter_LayerType_LOCAL:                  // Ydg
    return new LocalLayer<Dtype>(param);
  case LayerParameter_LayerType_MAP_DATA:               // Ydg
    return new MapDataLayer<Dtype>(param);
  case LayerParameter_LayerType_MAP_ARGMAX:             // Ydg
    return new MapArgMaxLayer<Dtype>(param);
  case LayerParameter_LayerType_MAP_ACCURACY:           // Ydg
    return new MapAccuracyLayer<Dtype>(param);
  case LayerParameter_LayerType_PYRAMID_MAP_DATA:       // Ydg
    return new PyramidMapDataLayer<Dtype>(param);
  case LayerParameter_LayerType_DEPTH_MAP_DATA:         // Ydg
    return new DepthMapDataLayer<Dtype>(param);
  case LayerParameter_LayerType_RANK2CLS:               // Ydg
    return new Rank2ClsLayer<Dtype>(param);
  case LayerParameter_LayerType_CLS2RANK:               // Ydg
    return new Cls2RankLayer<Dtype>(param);
  case LayerParameter_LayerType_SCALEALIGN_MAP_DATA:    // Ydg
    return new ScaleAlignMapDataLayer<Dtype>(param);
  case LayerParameter_LayerType_CONTOUR_MAP_DATA:       // Ydg
    return new ContourMapDataLayer<Dtype>(param);
  case LayerParameter_LayerType_RESIDUAL_LABEL:         // Ydg
    return new ResidualLabelLayer<Dtype>(param);
  case LayerParameter_LayerType_AVERAGE:                // Ydg
    return new AverageLayer<Dtype>(param);
  case LayerParameter_LayerType_HARD_NEGATIVE:          // Ydg
    return new HardNegativeLayer<Dtype>(param);
  case LayerParameter_LayerType_PATCH_DATA:             // Ydg
    return new PatchDataLayer<Dtype>(param);
  case LayerParameter_LayerType_PYRAMID_RECURRENT_MAP_DATA:       // Ydg
    return new PyramidRecurrentMapDataLayer<Dtype>(param);
  case LayerParameter_LayerType_RESIDUAL_VALUE:         // Ydg
    return new ResidualValueLayer<Dtype>(param);
  case LayerParameter_LayerType_EUCLIDEAN_LOSS_MASK:    // Ydg
    return new EuclideanLossMaskLayer<Dtype>(param);
  case LayerParameter_LayerType_POSITION_MAP_DATA:      // Ydg
    return new PositionMapDataLayer<Dtype>(param);
  case LayerParameter_LayerType_SCALE_MAP_DATA:         // Ydg
    return new ScaleMapDataLayer<Dtype>(param);
  case LayerParameter_LayerType_MULTI_SCALE_MAP_DATA:   // Ydg
    return new MultiScaleMapDataLayer<Dtype>(param);
  case LayerParameter_LayerType_DECONVOLUTION:          // Ydg
    return new DeconvolutionLayer<Dtype>(param);
  case LayerParameter_LayerType_MAP_DROPOUT:            // Ydg
    return new MapDropoutLayer<Dtype>(param);
  case LayerParameter_LayerType_MULTI_SCALE_MASK_MAP_DATA:   // Ydg
    return new MultiScaleMaskMapDataLayer<Dtype>(param);
  case LayerParameter_LayerType_MULTI_SCALE_CROP_MAP_DATA:   // Ydg
    return new MultiScaleCropMapDataLayer<Dtype>(param);
  case LayerParameter_LayerType_MAP_HINGE_LOSS:         // Ydg
    return new MapHingeLossLayer<Dtype>(param);
  case LayerParameter_LayerType_BBOX_REG_MAP_DATA:      // Ydg
    return new BBoxRegMapDataLayer<Dtype>(param);
